...
//		Fighter at = (Fighter) attacker;
//		Fighter df = (Fighter) getDefender();
//		ArrayList<SuperAttack> sa = ((Fighter)attacker).getSuperAttacks();
//		ArrayList<UltimateAttack> ua = ((Fighter)attacker).getUltimateAttacks();
//		if(df.getHealthPoints() <= 200)
//		{
//			if(at.getKi() >= 3 && ua.size() > 0)
//			{
//				int index = (int)(Math.random() * ua.size());
//				attack(ua.get(index));
//				return;
//			}
//			if(at.getKi() >= 1 && sa.size() > 0 )
//			{
//				int index = (int)(Math.random() * sa.size());
//				attack(sa.get(index));
//				return;
//			}
//			if(at.getHealthPoints() <= 200 && at.getStamina() >= 2)
//			{
//				block();
//				return;
//			}
//			
//		}
//		if(at.getStamina() >= 3 || at.getHealthPoints() <= 150 && at.getStamina() >= 1)
//		{
//			block();
//			return;
//		}
//		
//		if(at.getKi() == 0 && df.getHealthPoints() >= 700)
//		{
//			for ( int i = 0 ; i < sa.size() ; i++)
//			{
//				if(sa.get(i) instanceof MaximumCharge)
//				{
//					attack(sa.get(i));
//					return;
//				}
//			}
//			if(at.getHealthPoints() == at.getMaxHealthPoints() && at.getStamina() >= 3)
//			{	block();
//				return;
//			}
